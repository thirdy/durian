...
public class BackendApiTest {
	...
	public void searchUnique2() throws Exception {
		List<Item> result = BackendApi.searchUnique("Standard", "Tabula Rasa", 150000);
		result.stream().forEach(e -> System.out.println(e));
	}
	...
	public void get() throws Exception {
		String result = BackendApi.get("http://api.exiletools.com/index/_cluster/health");
		System.out.println(result);
	}
	
	@Test
	public void post() throws Exception {
		String raw = FileUtil.fromClasspath(BackendApiTest.class, "msearch.txt");
		String result = BackendApi.post("http://api.exiletools.com/index/_msearch", raw);
		System.out.println(result);
	}
	
	@Test
	public void xget() throws Exception {
		String raw = FileUtil.fromClasspath(BackendApiTest.class, "xgetsearch.txt");
//		String result = BackendApi.xget("http://api.exiletools.com/index/_search?pretty", raw);
		String result = BackendApi.get("http://api.exiletools.com/index/_search?pretty");
		System.out.println(result);
	}
